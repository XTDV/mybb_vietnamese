...
// Last edited date : Sun, 26 Oct 2014 12:53:46 +0000
// --------------------------------------------------------------------------------

$l['userdata_missing_username'] = 'Bạn chưa điền tên đăng nhập. Vui lòng điền vào.';
...
$l['userdata_no_complex_characters'] = 'Mật khẩu bạn nhập không đủ độ phức tạp. Vui lòng nhập mật khẩu với ít nhất {1} ký tự, có chứa CHỮ HOA, chữ thường và số.';
...
$l['userdata_invalid_msn_address'] = '';
...
$l['userdata_bad_password_security'] = 'Mật khẩu của bạn giống với tên đăng nhập hoặc địa chỉ email. Vui lòng nhập vào mật khẩu mạnh hơn.';
